...
public class BasicWebDriverTest {
    ...
    public void driverLevelInterrogation() {
        ...
        assertEquals("Basic Web Page | Test Pages", pageTitle);
        ...
        assertTrue(pageSource.contains("Very simple web pages have a structure"));
    ...
    public void canNavigateWithMultipleApproaches(){
        ...
        // using get
        driver.get(BasicConstants.TEST_DOMAIN + "/pages/basics/basic-web-page/");
        assertEquals("Basic Web Page",
                driver.findElement(By.tagName("h1")).getText());

        // or using navigate
        driver.navigate().to(BasicConstants.TEST_DOMAIN + "/pages/basics/element-attribute-examples/");
        assertEquals("Element Attributes",
                driver.findElement(By.tagName("h1")).getText());
