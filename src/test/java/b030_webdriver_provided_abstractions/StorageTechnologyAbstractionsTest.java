...
public class StorageTechnologyAbstractionsTest {
    ...
    public void createANoteAndAddToLocalStorage(){
        ...
        BrowserAppStorage storage = new WebStorage(driver).localStorage();
    ...
    public void createANoteAndAddToSessionStorage(){
        ...
        BrowserAppStorage storage = new WebStorage(driver).sessionStorage();
    ...
    // web storage was deprecated and removed Deprecate all html5 offline storage implementations See #10397 (#13373)

    // https://github.com/SeleniumHQ/selenium/issues/10397
